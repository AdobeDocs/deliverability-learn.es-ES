...
Una vez que haya delegado un dominio en un Adobe para enviar correo electrónico (consulte [Configuración del nombre de dominio](/help/putting-it-in-practice/ac-domain-name-setup.md)), Adobe creará y usará ciertos subdominios para funciones específicas.
