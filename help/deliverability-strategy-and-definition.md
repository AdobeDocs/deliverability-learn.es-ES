...
* Línea de asunto y preencabezados convincentes
* Personalización
* Frecuencia
...
* Todo lo anterior
* Transición del correo electrónico a través de una dirección URL de trabajo a una página de destino o página de ventas
